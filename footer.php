...
<div class="page-wrapper">
                  ...
                  <div class="widget footer_widget">
                    ...
                    <ul class="posts  styled">
                      <li class="clearfix gem-pp-posts">
                        <div class="gem-pp-posts-text">
                          <div class="gem-pp-posts-item">
                            <a href="#">Want to Build your own house.
                            </a>
                          </div>
                      ...
                      <li class="clearfix gem-pp-posts">
                        <div class="gem-pp-posts-text">
                          <div class="gem-pp-posts-item">
                            <a href="#">Now we are in Noida,Now we are in Gurugram Haryana.
                            </a>
                          </div>
                      ...
                      <li class="clearfix gem-pp-posts">
                        <div class="gem-pp-posts-text">
                          <div class="gem-pp-posts-item">
                            <a href="">Now we are in Noida,for sales and purchase
                            </a>
                          </div>
                          <div class="gem-pp-posts-date">Call +91-9122588799, +91-9122588799</div>
                        </div>
                  ...
                  <div class="widget">
                    ...
                    <div class="textwidget">
                      <div role="form" class="wpcf7" id="wpcf7-f4-o1" lang="en-US" dir="ltr">
                        ...
                        <form method="post" class="wpcf7-form" novalidate="novalidate" action="submit.php">
            ...
            <div class="col-12 col-lg-3 col-md-5 col-sm-12 footer-col-4">
              <div class="widget widget_gallery gallery-grid-4">
                ...
                <ul class="magnific-image">
                  ...
                  <li><a class="magnific-anchor"><img src="images/real.png" alt=""></a></li>
                  <li><a class="magnific-anchor"><img src="images/1.jpeg" alt=""></a></li>
                  <li><a class="magnific-anchor"><img src="images/2.jpeg" alt=""></a></li>
                  <li><a class="magnific-anchor"><img src="images/3.jpeg" alt=""></a></li>
                  <li><a class="magnific-anchor"><img src="images/4.jpeg" alt=""></a></li>
                  <li><a class="magnific-anchor"><img src="images/5.jpeg" alt=""></a></li>
                  <li><a class="magnific-anchor"><img src="images/6.jpeg" alt=""></a></li>
                  <li><a class="magnific-anchor"><img src="images/2.jpeg" alt=""></a></li>
                  <li><a class="magnific-anchor"><img src="images/4.jpeg" alt=""></a></li>
                </ul>
              </div>
      ...
      <div class="footer-bottom">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="footer-site-info">2024 © <a href="https://www.magicbricks.com/" target="_blank">Top seller and buyers Real state </a></div>
            </div>

          <div class="col-md-6">
              <nav id="footer-navigation" class="site-navigation footer-navigation centered-box" role="navigation">
                <ul id="footer-menu" class="nav-menu styled clearfix inline-inside">
                  <li id="menu-item-26" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-26"><a href="https://www.realestate-support.com/">Support</a></li>
                  <li id="menu-item-27" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-27"><a href="http://localhost/real%20estate/contact.php">Contact Us</a></li>
                  <li id="menu-item-28" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-28"><a href="https://shapoorjirealestate.com/disclaimer/">Disclaimer</a></li>
                  <li id="menu-item-29" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-29"><a href="https://realhomes.io/documentation/add-property/">Add more</a></li>
                </ul>
              </nav>
            </div>
 ...
 <script> jQuery('#waterdrop').raindrops({color:'#1c1f2f', canvasHeight:150, density: 0.1, frequency: 40});
</script>